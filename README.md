...
2. Install all the libraries mentioned in the [requirements.txt](https://github.com/sahilsaqi/Movie-recommendation-system/requirements.txt) file with the command `pip install -r requirements.txt`
